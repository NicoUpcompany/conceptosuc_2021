...
const agenda1 = [
    {
        finalDate : moment(momentTimezone.tz("2021-11-12T08:30:00", "America/Santiago")).format(),
        title: 'Bienvenida',
        hour: '08:30',
        hourEnd: '08:35'
    },  
    ...
    {
        finalDate : moment(momentTimezone.tz("2021-11-12T09:50:00", "America/Santiago")).format(),
        title: 'Mesa redonda',
        hour: '09:50',
        hourEnd: '10:20'
    },  
    ...
    {
        finalDate : moment(momentTimezone.tz("2021-11-12T11:10:00", "America/Santiago")).format(),
    ...
    {
        finalDate : moment(momentTimezone.tz("2021-11-12T16:00:00", "America/Santiago")).format(),
